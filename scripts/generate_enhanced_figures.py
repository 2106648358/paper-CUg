...
X = np.array([
    ...
    [0.9500, 0.65, 0.8500, 0.5500, 1.0000, 0.95],
    [0.5034, 0.92, 0.6258, 0.2694, 0.9846, 0.55],
    [0.8143, 0.88, 0.9547, 1.0000, 0.0268, 0.75],
    [0.5799, 0.95, 0.7156, 0.4315, 0.4176, 0.88],
    [0.3485, 0.90, 0.5675, 0.2944, 0.9846, 0.85],
    [0.3940, 0.90, 0.6258, 0.2944, 0.9846, 0.35],
    [0.3688, 0.90, 0.6258, 0.2694, 0.9846, 0.80],
    [0.3273, 0.92, 0.5000, 0.1097, 1.0000, 0.70],
    [0.2048, 0.70, 0.5000, 0.2472, 0.0231, 0.65],
...
cand_scores = np.array([
    [0.9500, 0.65, 0.8500, 0.5500, 1.0000, 0.95],
    [0.2048, 0.70, 0.5000, 0.2472, 0.0231, 0.65],
    [0.5000, 0.88, 0.7800, 0.7000, 0.8200, 0.90],
    [0.0600, 0.88, 0.5000, 0.1500, 0.5000, 0.65],
    [0.6000, 0.60, 0.7000, 0.4500, 0.3500, 0.60],
])
